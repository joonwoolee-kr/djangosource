...
# AbstractBaseUer: password, last_login 필드만 가지고 있음
# AbstractUser: is_superuser, groups, user_permission 필드 가지고 있음
# User


# User 모델에 다른 필드 추가하고 싶다면?
# 1)
